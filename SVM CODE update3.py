...
plt.title('Linear Kernel SVM Confusion Matrix', fontsize=18)
plt.show()
...
plt.xlabel('Predicted Class', fontsize=18)
plt.ylabel('Actual Class', fontsize=18)
plt.title('Polynomial Kernel SVM Confusion Matrix', fontsize=18)
plt.show()
...
print("CLASSIFICATION REPORT FOR RADIAL BASIS FUNCTION KERNEL SVM")
print("Confusion Matrix:")
print(confusion_matrix(y_test,y_pred))
print()
print(classification_report(y_test,y_pred,target_names=fruits))
...
plt.xlabel('Predicted Class', fontsize=18)
plt.ylabel('Actual Class', fontsize=18)
plt.title('Radial Basis Function Kernel SVM Confusion Matrix', fontsize=18)
plt.show()